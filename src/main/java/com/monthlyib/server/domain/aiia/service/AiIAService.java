...
public class AiIAService {
    ...
    public Map<String, Object> createTopicGuide(String subject, String interestTopic, Map<String, Object> topic, User user) {
        Logger log = LoggerFactory.getLogger(AiIAService.class);
        ...
        try {
            ...
            // }
            //
            // Prefer a string title if available; otherwise fallback to a compact string of the topic map
